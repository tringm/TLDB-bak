...
from tldb.core.lib.boundary import update_boundary_from_entry, update_boundary_from_node
from tldb.core.lib.dewey_id import get_center_index
from tldb.core.lib.entries import get_boundaries_from_entries
from tldb.core.lib.nodes import get_boundaries_from_nodes
...
class Node:
    ...
    def __init__(self, max_n_children, name, parent=None, children=None, entries=None):
        self._max_n_children = max_n_children
        self._parent = parent
        self._name = name
        self._children = [] if children is None else children
        self._entries = [] if entries is None else entries
        self._original_boundary = self.init_boundary()
        self._boundary = self._original_boundary
        self.is_leaf = False
    ...
    def children(self, new_children):
        ...
        self._boundary = get_boundaries_from_nodes(new_children)
    ...
    def entries(self, value):
        self._entries = value
        self._boundary = get_boundaries_from_entries(value)
    ...
    def add_entry(self, entry):
        ...
        self._boundary = update_boundary_from_entry(self.boundary, entry)

    def add_child_node(self, node):
        self._children.append(node)
        self._boundary = update_boundary_from_node(self.boundary, node)
...
class XMLNode(Node):
    ...
    """
    def __init__(self, max_n_children, name, parent=None, children=None, entries=None):
        super().__init__(max_n_children, name, parent, children, entries)
