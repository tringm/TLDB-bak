...
class Node:
	...
	Attributes:
	    boundary (list of tuple): containing coordinates of a dimension. 
	    ...
	    max_n_entries (int): maximum number of entries in a leaf node
	...
	def __init__(self, max_n_children, max_n_entries):
        self.parent = None
